...
<div class="site-index">
    ...
    <div class="jumbotron">
        <h1>Welcome to EarSaver!</h1>
        <p class="lead">Hier zie je festivals die op dit moment aan de gang zijn!</p>
        <?= Html::a('Andere festivals', ['festival/index'], ['class' => 'btn btn-lg btn-success']) ?>
    </div>
